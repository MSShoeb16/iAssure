        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MeasureGroups_Standards_StandardId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MeasureGroupId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastUpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Measures_MeasureGroups_MeasureGroupId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeasureGroups_StandardId",
                table: "MeasureGroups",
                column: "StandardId");

            migrationBuilder.CreateIndex(
                name: "IX_Measures_MeasureGroupId",
                table: "Measures",
